...
if __name__ == '__main__':
    ...
    create_coinpair_table('BTC','BNB',dbconn)
    create_coinpair_table('BTC','ADA',dbconn)
    create_coinpair_table('BTC','MATIC',dbconn)
    create_coinpair_table('BTC','XRP',dbconn)
    create_coinpair_table('BTC','DOT',dbconn)
    create_coinpair_table('BTC','DOGE',dbconn)
    create_coinpair_table('BTC','LTC',dbconn)
    create_coinpair_table('BTC','EOS',dbconn)
    create_coinpair_table('BTC','ETC',dbconn)
    create_coinpair_table('BTC','VET',dbconn)
    create_coinpair_table('BTC','XLM',dbconn)
    create_coinpair_table('BTC','RUNE',dbconn)
    create_coinpair_table('BTC','NEO',dbconn)
    create_coinpair_table('BTC','LINK',dbconn)
    create_coinpair_table('ETH','BNB',dbconn)
    create_coinpair_table('ETH','VET',dbconn)
    create_coinpair_table('ETH','ADA',dbconn)
    create_coinpair_table('ETH','LINK',dbconn)
    create_coinpair_table('ETH','XRP',dbconn)
    create_coinpair_table('ETH','EOS',dbconn)
    create_coinpair_table('ETH','LTC',dbconn)
    create_coinpair_table('ETH','ETC',dbconn)
    create_coinpair_table('ETH','LTX',dbconn)
    create_coinpair_table('ETH','XLM',dbconn)
    create_coinpair_table('ETH','NEO',dbconn)
    create_coinpair_table('ETH','RUNE',dbconn)
    create_coinpair_table('ETH','NANO',dbconn)
    create_coinpair_table('ETH','DASH',dbconn)
